...
namespace CC1101
{
   ...
   namespace Address
   {
            constexpr uint8_t IOCFG1      = 0x01;         // GDO1 / SO pin configuration. This pin shares the SPI SO function while CSn is low.
   ...
   namespace Value
   {
        constexpr uint8_t IOCFG1          = 0x2E;        // Keep GDO1 in High-Z when it is not acting as SPI SO. This makes post-CSn logic captures less misleading.
   ...
   inline const __FlashStringHelper* registerName(uint8_t address)
   {
      switch (address)
      {
         case Address::IOCFG1: return F("IOCFG1");
         case Address::IOCFG0: return F("IOCFG0");
         case Address::FIFOTHR: return F("FIFOTHR");
         case Address::PKTLEN: return F("PKTLEN");
         case Address::PKTCTRL0: return F("PKTCTRL0");
         case Address::FSCTRL1: return F("FSCTRL1");
         case Address::FSCTRL0: return F("FSCTRL0");
         case Address::FREQ2: return F("FREQ2");
         case Address::FREQ1: return F("FREQ1");
         case Address::FREQ0: return F("FREQ0");
         case Address::MDMCFG4: return F("MDMCFG4");
         case Address::MDMCFG3: return F("MDMCFG3");
         case Address::MDMCFG2: return F("MDMCFG2");
         case Address::MDMCFG1: return F("MDMCFG1");
         case Address::DEVIATN: return F("DEVIATN");
         case Address::FREND1: return F("FREND1");
         case Address::FREND0: return F("FREND0");
         case Address::MCSM0: return F("MCSM0");
         case Address::MCSM1: return F("MCSM1");
         case Address::WORCTRL: return F("WORCTRL");
         case Address::FSCAL3: return F("FSCAL3");
         case Address::FSCAL2: return F("FSCAL2");
         case Address::FSCAL1: return F("FSCAL1");
         case Address::FSCAL0: return F("FSCAL0");
         case Address::PATABLE: return F("PATABLE");
         case Address::PARTNUM: return F("PARTNUM");
         case Address::VERSION: return F("VERSION");
         case Address::MARCSTATE: return F("MARCSTATE");
         case 0x32: return F("FREQEST");
         case 0x33: return F("LQI");
         case 0x34: return F("RSSI");
         case 0x36: return F("WORTIME1");
         case 0x37: return F("WORTIME0");
         case 0x38: return F("PKTSTATUS");
         case 0x39: return F("VCO_VC_DAC");
         case 0x3A: return F("TXBYTES");
         case 0x3B: return F("RXBYTES");
         case 0x3C: return F("RCCTRL1_STATUS");
         case 0x3D: return F("RCCTRL0_STATUS");
         case 0x3F: return F("FIFO");
